...
contextBridge.exposeInMainWorld('preload', {
    ...
    // New IPC methods for Spine file loading
    onLoadSpineFile: (callback) => ipcRenderer.on('load-spine-file', (_event, filePath) => callback(filePath)),
    loadSpineFile: (filePath) => ipcRenderer.send('load-spine-file', filePath)
});